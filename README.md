...
### [OpenClaw Gateway](https://github.com/ssrajadh/openclaw-gateway) — Enterprise security proxy for AI agents
...
### [OpenGrove](https://github.com/ssrajadh/opengrove) — Local-first AI conversation manager
